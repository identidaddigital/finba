...
if ( ! class_exists( 'ReduxFramework_basel_multi_fonts' ) && class_exists( 'ReduxFramework' ) ) {
    ...
    class ReduxFramework_basel_multi_fonts extends ReduxFramework {
        ...
        public function render() {
            ...
            //Add new btn
            echo '<a href="javascript:void(0);" class="button button-alternative basel-multi-fonts-add" data-id="' . esc_attr( $this->field['id'] ) . '-ul"  data-name="' . esc_attr( $this->field['name'] . $this->field['name_suffix'] ) . '" data-order="' . esc_attr( $this->order ) . '">'. esc_html__( 'Add More', 'basel' ) .'</a>';
        }
